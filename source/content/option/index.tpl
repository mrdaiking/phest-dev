...
<section class="banner-image mobile-order">
  ...
  <div class="content">
    ...
    <figure>
        <img src="../common/img/option/mobile-order/mobile_order_item.png" srcset="../common/img/option/mobile-order/mobile_order_item@2x.png 2x">
    </figure>
  </div>
</section>
...
<section class="banner-image uber-eats ">
  ...
  <div class="content">
    ...
    <figure>
        <img src="../common/img/option/uber-eats/uber_eats_item.png" srcset="../common/img/option/uber-eats/uber_eats_item@2x.png 2x">
    </figure>
  </div>
</section>
...
<section class="banner-image take-out">
  ...
  <div class="content">
    <div class="content-description">
      <p class="label">テイクアウト</p>
      <h3>テイクアウトはWEBで完結お店オリジナルのフォームを作成</h3>
      <p>
        独自のテイクアウトフォームを作成可能。大手ポータルのテイクアウトに依存しないので、余分な手数料はかかりません。
        テイクアウトフォームからの注文はPOSレジに反映、キッチン伝票から出力可能。店内オペレーションを変えることなく、待ち時間ゼロのテイクアウト販売を開始できます。
      </p>
    </div>
    <figure>
        <img src="../common/img/option/take-out/take_out_item.png" srcset="../common/img/option/take-out/take_out_item@2x.png 2x">
    </figure>
  </div>
</section>
